...
describe('/api/user', function () {
  ...
  describe('/api/user', function () {
    describe('POST', function () {
      ...
      it('Should reject user with non-string username', function () {
        return chai
          .request(app)
          .post('/api/user')
          .send({
      ...
      it('Should reject user with non-string password', function () {
        return chai
          .request(app)
          .post('/api/user')
          .send({
      ...
      it('Should reject user with non-string first name', function () {
        return chai
          .request(app)
          .post('/api/user')
          .send({
      ...
      it('Should reject user with password less than ten characters', function () {
        return chai
          .request(app)
          .post('/api/user')
          .send({
      ...
      it('Should reject user with password greater than 72 characters', function () {
        return chai
          .request(app)
          .post('/api/user')
          .send({
    ...
    //     return chai.request(app).get('/api/user').then(res => {
    //       expect(res).to.have.status(200);
    //       expect(res.body).to.be.an('array');
    //       expect(res.body).to.have.length(0);
    //     });
    //   });
    //   it('Should return an array of user', function () {
    //     return User.create(
    //       {
    //         username,
    //         password,
